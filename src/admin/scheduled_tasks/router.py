...
from ...core.database.models import ScheduledTask
from ..config import get_current_admin_user, ADMIN_CONFIG
from ..shared.models import AdminScheduledTaskResponse
...
async def admin_scheduled_tasks(
    ...
    offset = (page - 1) * limit
    scheduled_tasks = db.query(ScheduledTask).offset(offset).limit(limit).all()
