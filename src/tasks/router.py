...
@router.get("/", response_model=List[pydantic_models.TaskModel])
...
@router.get("/{task_id}", response_model=pydantic_models.TaskModel)
...
@router.put("/{task_id}", response_model=pydantic_models.TaskModel)
def update_task(task_id: int, task_update: pydantic_models.TaskUpdate, db: Session = Depends(get_db)):
...
@router.get("/scheduled", response_model=List[pydantic_models.ScheduledTaskModel])
...
@router.get("/scheduled/{scheduled_task_id}", response_model=pydantic_models.ScheduledTaskModel)
...
@router.put("/scheduled/{scheduled_task_id}", response_model=pydantic_models.ScheduledTaskModel)
def update_scheduled_task(
    scheduled_task_id: int,
    scheduled_task_update: pydantic_models.ScheduledTaskUpdate,
    db: Session = Depends(get_db)
):
